        ...
        _appLifetime.ApplicationStarted.Register(() =>
        {
            Task.Run(async () =>
            {
                ...
                try
                {
                    ...
                    string extractionPath = await _extractionUtil.Extract7Zip(fileName, "ffprobe.exe");

                    await _fileOperationsUtil.Process(Path.Combine(extractionPath, "bin", "ffprobe.exe")); ;
